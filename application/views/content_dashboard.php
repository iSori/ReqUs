<body>
	...
	<p class="center"><a href="<?php echo base_url() ?>site/new_requirement">Click to add a new requirement</a></p>
	...
	<?php
		...
		foreach($requirements->result() as $req){
			...
			echo "</td>
					...
					<div class='req_comments'>
						<table>
							<table>
								<tr>";
			foreach($comments[$id]->result() as $comm){
			...
			if($this->session->userdata('is_logged_in')){
				echo "<td id='comm'>". form_open("site/add_comment");
